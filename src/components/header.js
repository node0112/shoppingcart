    ...
    return ( //link logo homepage
        <div className="header">
            ...
            <ul className="header-list links">
                ...
                <li className="transition" onClick={()=>{navigate('/shop')}}><a className="header-link transition">Airpods</a></li>
                <li className="transition" onClick={()=>{navigate('/shop')}}><a className="header-link transition">Iphones</a></li>
                <li className="transition" onClick={()=>{navigate('/shop')}}><a className="header-link transition">Macs</a></li>
            </ul>
